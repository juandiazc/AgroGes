...
''' <summary>
'''  Clase encargada del manejo de la entidad TBL_Enc_Trabajadores en la capa de Negocios
''' </summary>
''' <remarks>
...
''' </history>
public class TBL_Enc_Trabajadores_Negocio

#REGION "METODOS DE LOGICA DE NEGOCIOS"

   ''' <summary>
   ''' Permite Modificar un objeto del tipoTBL_Enc_Trabajadores_class en la aplicación
   ''' </summary>
   Public Sub Insertar(byval TBL as TBL_Enc_Trabajadores)
       Try
           Dim TBL_DAO as new TBL_Enc_Trabajadores_DAO
   ...
   ''' <summary>
   ''' Permite Modificar un objeto del tipoTBL_Enc_Trabajadores en la aplicación
   ''' </summary>
   ...
   End Sub
    ...
    End Sub
   ''' <summary>
   ''' Permite Eliminar un objeto del tipoTBL_Enc_Trabajadores en la base de datos
   ''' </summary>
   ...
   ''' <summary>
   ''' Permite Listar un objeto del tipoTBL_Enc_Trabajadores en la base de datos
   ''' </summary>
